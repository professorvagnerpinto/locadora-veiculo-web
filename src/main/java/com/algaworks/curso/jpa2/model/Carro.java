...
public class Carro {
	...
	@ManyToOne //(fetch=FetchType.LAZY) //para buscar só quando houver necessidade
	@JoinColumn(name="codigo_modelo")
	private ModeloCarro modelo;
	@ManyToMany
	//Alternativamente dá para escrever todas as partes desse mapeamento (anotação abaixo)
